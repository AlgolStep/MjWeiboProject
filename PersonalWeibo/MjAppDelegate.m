...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    MjSinaDelegate *mjSinaDelegate = [[MjSinaDelegate alloc]init];
    _sinaWeibo = [[SinaWeibo alloc]initWithAppKey:kAppKey appSecret:kAppSecret appRedirectURI:kAppRedirectURI andDelegate:mjSinaDelegate];
    
    if ([NSUD boolForKey:@"firstLaunch"]) {
        [MjViewControllerManager presentMjController:MjuserGuideViewController];
    }else
    {
        if ([NSUD boolForKey:@"remberPwd"]) {
